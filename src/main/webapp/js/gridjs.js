!function(t, n) {
        ...
        for (var t; I.__r = h.length; )
            t = h.sort(function(t, n) {
                ...
                t.some(function(t) {
                    ...
                    (u = n.__P) && (e = [],
                        (r = b({}, o)).__v = o.__v + 1,
                        R(u, o, r, n.__n, void 0 !== u.ownerSVGElement, null != o.__h ? [i] : null, e, null == i ? N(o) : i, o.__h),
                        F(e, o),
                    o.__e != i && C(o)))
                })
    }
        ...
        for (e.__k = [],
            ...
            if (null != (d = e.__k[c] = null == (d = n[c]) || "boolean" == typeof d ? null : "string" == typeof d || "number" == typeof d || "bigint" == typeof d ? k(null, d, null, null, d) : Array.isArray(d) ? k(P, {
                ...
                p.ref && m.push(p.ref, null, d),
                    ...
                    "function" == typeof e.type && (e.__d = a)) : a && p.__e == a && a.parentNode != t && (a = N(p))
            }
        for (e.__e = _,
                 c = b; c--; )
            null != y[c] && W(y[c], y[c]);
        ...
        try {
            t: if ("function" == typeof E) {
                if (v = n.props,
                    ...
                    e.__c ? m = (c = n.__c = e.__c).__ = c.__E : ("prototype"in E && E.prototype.render ? n.__c = c = new E(v,y) : (n.__c = c = new S(v,y),
                        c.constructor = E,
                        c.render = B),
                    g && g.sub(c),
                        c.props = v,
                ...
                p || null == c.getSnapshotBeforeUpdate || (_ = c.getSnapshotBeforeUpdate(d, h)),
                    C = null != l && l.type === P && null == l.key ? l.props.children : l,
    ...
    function O(t, n, e, r, o, i, u, s) {
        ...
        if (null === h)
            ...
            if (function(t, n, e, r, o) {
                var i;
                for (i in e)
                    "children" === i || "key" === i || i in n || H(t, i, null, e[i], r);
                for (i in n)
                    o && "function" != typeof n[i] || "children" === i || "key" === i || "value" === i || "checked" === i || e[i] === n[i] || H(t, i, n[i], e[i], r)
            }(t, d, p, o, s),
                f)
                n.__k = [];
            else if (_ = n.props.children,
                T(t, Array.isArray(_) ? _ : [_], n, e, r, o && "foreignObject" !== h, i, u, i ? i[0] : e.__k && N(e, 0), s),
            null != i)
                for (_ = i.length; _--; )
                    null != i[_] && w(i[_]);
            s || ("value"in d && void 0 !== (_ = d.value) && (_ !== t.value || "progress" === h && !_ || "option" === h && _ !== p.value) && H(t, "value", _, p.value, !1),
            "checked"in d && void 0 !== (_ = d.checked) && _ !== t.checked && H(t, "checked", _, p.checked, !1))
        }
        return t
    }
    function U(t, n, e) {
    ...
    function q(t, n, e) {
        ...
        f.__ && f.__(t, n),
            ...
            i = [],
            R(n, t = (!r && e || n).__k = x(P, null, [t]), o || v, v, void 0 !== n.ownerSVGElement, !r && e ? [e] : o ? null : n.firstChild ? c.call(n.childNodes) : null, i, !r && e ? e : o ? o.__e : n.firstChild, r),
            F(i, t)
    }
    function z() {
    ...
    function Y(t, n) {
        ...
        for (var i = 0, u = r; i < u.length; i++) {
            var s = u[i];
            if (!n.hasOwnProperty(s) || !Y(t[s], n[s]))
                return !1
        }
        return !0
    }
        ...
        function(t) {
            ...
            return i.process = function() {
                ...
                i.setProps = function(t) {
                    ...
                    return Y(n, this._props) || (this._props = n,
    ...
    var ot, it, ut, st, at = /*#__PURE__*/
        function(t) {
            ...
            return o(n, t),
                ...
                n
        }(tt), lt = 0, ct = [], ft = [], pt = f.__b, dt = f.__r, ht = f.diffed, _t = f.__c, mt = f.unmount;
    function vt(t, n) {
        f.__h && f.__h(it, t, lt || n),
            lt = 0;
        var e = it.__H || (it.__H = {
            __: [],
            __h: []
    ...
    function gt(t) {
        return lt = 1,
            function(t, n, e) {
                var r = vt(ot++, 2);
                if (r.t = t,
                !r.__c && (r.__ = [Et(void 0, n), function(t) {
    ...
    f.__b = function(t) {
        ...
        f.diffed = function(t) {
            ht && ht(t);
            var n = t.__c;
            n && n.__H && (n.__H.__h.length && (1 !== ct.push(n) && st === f.requestAnimationFrame || ((st = f.requestAnimationFrame) || Pt)(xt)),
    ...
    function Mt() {
        var t, n = gt(void 0), e = n[0], r = n[1], o = It(), i = o.search, u = At(), s = Ht().dispatch, a = Dt(function(t) {
            return t.search
        });
        yt(function() {
            e && e.setProps({
        ...
        var l, c, f, p = function(t, n) {
            return lt = 8,
                ...
                t.target instanceof HTMLInputElement && s(jt(t.target.value))
            }
                ,
    ...
    function Ot() {
        var t = It()
            ...
            , N = At();
        yt(function() {
            return e ? (v.current = new Ft({
                limit: p,
                page: y,
                url: e.url,
                body: e.body
            }),
                t.pipeline.register(v.current)) : (v.current = new Rt({
                limit: p,
                page: y
            }),
                ...
                v.current instanceof Ft ? t.pipeline.on("afterProcess", function(t) {
                    return S(t.length)
                }) : v.current instanceof Rt && v.current.on("beforeProcess", function(t) {
                    return S(t.length)
                }),
        ...
        return x("div", {
            ...
            return y + Math.floor(n / 2) >= E() && (e = n - (E() - y)),
                x(P, null, E() > n && y - e > 0 && x(P, null, x("button", {
                    tabIndex: 0,
                    role: "button",
                    onClick: function() {
                        return I(0)
    ...
    t.PluginPosition = void 0,
        (zt = t.PluginPosition || (t.PluginPosition = {}))[zt.Header = 0] = "Header",
    ...
    var $t = /*#__PURE__*/
        function() {
            ...
            return n.get = function(t) {
                ...
                ,
                n.add = function(t) {
                    return t.id ? this.get(t.id) ? (Vt.error("Duplicate plugin ID: " + t.id),
                        this) : (this.plugins.push(t),
                        this) : (Vt.error("Plugin ID cannot be empty"),
                        this)
                }
                ,
                n.remove = function(t) {
    ...
    var Kt = /*#__PURE__*/
        function(n) {
            ...
            return u.adjustWidth = function(t, n, e) {
                ...
                for (var c, f = a(i.tabularFormat(this.columns).reduce(function(t, n) {
                    ...
                    var p = c.value;
                    p.columns && p.columns.length > 0 || (!p.width && u ? p.id in l && (p.width = Wt(l[p.id].width),
                        p.minWidth = Wt(l[p.id].minWidth)) : p.width = Wt(Ut(p.width, s)))
                }
                ...
                u.setID = function(t) {
                    for (var n, e = a(t || this.columns || []); !(n = e()).done; ) {
                        ...
                        r.id || Vt.error('Could not find a valid ID for one of the columns. Make sure a valid "id" is set for all columns.'),
        ...
        function(t) {
            ...
            return e.handler = function(t) {
                return "function" == typeof this.options.handle ? this.options.handle(t) : t.ok ? t.json() : (Vt.error("Could not fetch data: " + t.status + " - " + t.statusText, !0),
                    null)
            }
                ,
                e.get = function(t) {
        ...
        function() {
            ...
            return t.createFromConfig = function(t) {
                var n = null;
                return t.data && (n = new Zt(t.data)),
                t.from && (n = new Zt(this.tableElementToArray(t.from)),
    ...
    function tn(t, n, e) {
        if (!t.s) {
            if (e instanceof nn) {
                if (!e.s)
                    return void (e.o = tn.bind(null, t, n));
                1 & n && (n = e.s),
                    e = e.v
            }
            if (e && e.then)
        ...
        function(t) {
            ...
            return r.clearCache = function() {
                ...
                r.register = function(t, n) {
                    ...
                    return t.on("propsUpdated", this.processorPropsUpdated.bind(this)),
                                            ...
                                            try {
                                                for (; !(r = u.next()).done; )
                                                    if ((e = n(r.value)) && e.then) {
                                                        if (!en(e))
                                                            return void e.then(t, i || (i = tn.bind(null, o = new nn, 2)));
                                                        e = e.v
                                                    }
                                                o ? tn(o, 1, e) : o = e
                                            } catch (t) {
                                        ...
                                        return function e(u) {
                                            try {
                                                for (; ++i < t.length; )
                                                    if ((u = n(i)) && u.then) {
                                                        if (!en(u))
                                                            return void u.then(e, o || (o = tn.bind(null, r = new nn, 2)));
                                                        u = u.v
                                                    }
                                                r ? tn(r, 1, u) : r = u
                                            } catch (t) {
    ...
    var vn = /*#__PURE__*/
        function(t) {
            ...
            return r.validateProps = function() {
                for (var t, n = a(this.props.columns); !(t = n()).done; ) {
                    ...
                    1 !== e.direction && -1 !== e.direction && Vt.error("Invalid sort direction " + e.direction)
                }
            }
                ,
        ...
        return function(i) {
            var u, s = null != (u = i.sort) && u.columns ? i.sort.columns.map(function(t) {
                return r({}, t)
            }) : [], a = s.length, l = s.find(function(n) {
                return n.index === t
            }), c = !1, f = !1, p = !1, d = !1;
            if (void 0 !== l ? e ? -1 === l.direction ? p = !0 : d = !0 : 1 === a ? d = !0 : a > 1 && (f = !0,
                c = !0) : 0 === a ? c = !0 : a > 0 && !e ? (c = !0,
                f = !0) : a > 0 && e && (c = !0),
            f && (s = []),
                c)
                s.push({
    ...
    function wn(t) {
        ...
        return yt(function() {
            ...
            yt(function() {
                if (l) {
                    var n = l.columns.find(function(n) {
    ...
    var xn = function(t, n) {
        ...
        var r = Date.now()
            , o = function() {
            r = Date.now(),
                t.apply(void 0, [].slice.call(arguments))
        };
        return function() {
            var t = [].slice.call(arguments)
                , i = Date.now()
                , u = i - r;
            u >= n ? o.apply(void 0, t) : (e && clearTimeout(e),
    ...
    function Pn(t) {
        ...
        var a, l = function() {
            ...
            e.stopPropagation(),
            l() && s(yn(t.index, !0 === e.shiftKey && n.sort.multiColumn, t.column.sort.compare))
        };
        return x("th", r({
            ref: e,
            "data-column-id": t.column && t.column.id,
        ...
        function(t) {
            ...
            return e.updateConfig = function(t) {
                ...
                e.forceRender = function() {
                    return this.config && this.config.container || Vt.error("Container is empty. Make sure you call render() before forceRender()", !0),
                        this.destroy(),
                ...
                ,
                e.render = function(t) {
                    return t || Vt.error("Container element cannot be null", !0),
                        t.childNodes.length > 0 ? (Vt.error("The container element " + t + " is not empty. Make sure the container is empty and call render() again"),
